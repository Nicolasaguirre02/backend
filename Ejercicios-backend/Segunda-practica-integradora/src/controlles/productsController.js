...
async function getProductsController(req, res){
    try {
        ...
        const respuestaProducto = await productsService.getProductsService(limite, pagina, order, disponible)
...
async function getProductId(req, res){
    try {
        ...
        let respuestaProducto = await productsService.getProductIdService(productID);
...
async function newProduct(req, res){
    try {
       ...
       let result =  await productsService.newProductService({titulo,price,disponible});
...
async function putProduct(req, res){
    try {
        ...
        let respuestaProduct = await productsService.putProductService(productID, productModificado)
